...
public class C08_JSONObjectVerileriCagirma {
    ...
    public void jsonPath01(){
        ...
        System.out.println("PostaKodu: "+ kisiBilgisi.getJSONObject("address").get("postalCode"));
        System.out.println("Sokak: "+ kisiBilgisi.getJSONObject("address").get("streetAddress"));
        System.out.println("Sokak: "+ kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(0).get("number"));
